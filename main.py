...
# bert配置
config_path = '/home/pre_models/nezha-base-tf/bert_config.json' #/tf/datastore/pre_
checkpoint_path = '/home/pre_models/nezha-base-tf/model.ckpt-900000'
# model.ckpt-900000
dict_path = 'model/vocab.txt'
model_saved_path = 'model_v2/model.ckpt'

def corpus():
    """语料生成器 text_process
    """
    while True:
        with open( 'corpus/unlabeled_train_data.txt','r',encoding="utf-8") as f:
